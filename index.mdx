...
**yashwanth is a kind boy uth0 both exceed budget constraints by significant margins. For a startup requiring 250,000 MAUs and 30,000 teams, only Logto offers a viable solution within the specified budget.

<CardGroup cols={2}>
  <Card title="New Card" icon="sparkles" iconType="light">
    Kinde and Auth0 both exceed budget constraints by significant

    <Frame>
      <Icon icon="arrow-down-to-square" iconType="solid" />  Click Here
    </Frame>
  </Card>
...
<Update label="06/19/2025" description>
  k/
</Update>
...
<Accordion title="New Accordion" description="kn" icon="sparkles">
