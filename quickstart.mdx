...
Learn how to update your docs locally and deploy them to the public. asdasa
...
<AccordionGroup>
  <Accordion title="Clone your docs locally" icon="github">
    ...
    <AccordionGroup>
      <Accordion title="Clone your docs locally" icon="github">
        your docs content. You can find this repository on our [dashboard](https://dashboard.mintlify.com). To clone the repository locally, follow these [instructions](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository) in your terminal.
      </Accordion>
